"""Public entry point for checking release readiness of the repository."""
...
def build_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--run-id", default="repository_check", help="Output directory name under runs/.")
...
def main() -> int:
    """Run the repository check and return a process exit code."""
    ...
    print(json.dumps({"status": result.status, "failed_step_count": result.failed_step_count, "feedback": str(result.feedback)}, indent=2))
